...
INTERNAL_DEVICE_KERNEL_am57xx-evm = "mmcblk1"

# the name of the bootloader config file to be written to internal media
INTERNAL_DEVICE_BOOTLOADER_CONFIG_am57xx-evm = "uEnv.txt_internal"
...
INTERNAL_DEVICE_BOOTLOADER_CONFIG_PATH_am57xx-evm = "/uEnv.txt"
